...
describe('Werewolf', function() {
  ...
  it('should not be hungry after changing back to human form', function () {
    ...
    werewolf.completeTransformation(); //makes it wolf then hungry
    werewolf.completeTransformation(); //makes it human

    assert.equal(werewolf.form, 'human'); //from 88
    assert.equal(werewolf.hungry, false);
  });
  ...
  it('should be able to eat a victim once hungry', function () {
    ...
    werewolf.completeTransformation();
    var fullWolf = werewolf.eatVictim(victim); //new instance of vitim class is being passed for the arg of the new class
  ...
  it('should not be able to eat a victim while in human form', function() {
    ...
    werewolf.completeTransformation(); //wolf
    werewolf.completeTransformation(); //human
