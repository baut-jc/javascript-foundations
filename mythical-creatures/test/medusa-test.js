...
describe('Medusa', function() {
  ...
  it('should gain a statue when staring at a person', function() {
    ...
    medusa.gazeAtVictim(victim1); //passing instances of the Person class
    medusa.gazeAtVictim(victim2);

    assert.equal(medusa.statues.length, 2);
    assert.instanceOf(medusa.statues[0], Statue); //pushing a new instance of Statue w/in function
